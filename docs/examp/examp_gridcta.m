...
[scan, scanoffset, fitobj] = gridcta(0:50:500, -1000:500:1000, 500, ...
    offset = {[0, 100], [], [0, 500]}, offsetdim = 3,  ...
    fit = 'poly1', unit = 'mm', skew = [0, 0; 0, 2e4; 300, 2e4; 300, 0], ...
    ort = [113.9, 63.7; 113.9, 112.4; 126.8, 118.9; 126.7, 70.2])
%% save plots
saf('docs\plt',md="docs\func\gridcta.md",size=[10,10],mdfig=false)